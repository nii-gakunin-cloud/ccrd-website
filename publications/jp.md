...
- [Paper] Efficient use of commercial cloud for astronomical data archive and data analysis, George Kosugi, Eisuke Morita, Takeshi Nakazato, Renaud Miel, Hiroaki Tagawa, Kanako Sugimoto, Kento Aida, Hiroshi Yoshida, Proc. SPIE Astronomical Telescopes + Instrumentation: Software and Cyberinfrastructure for Astronomy VIII (2024). [Link](https://doi.org/10.1117/12.3019514)
